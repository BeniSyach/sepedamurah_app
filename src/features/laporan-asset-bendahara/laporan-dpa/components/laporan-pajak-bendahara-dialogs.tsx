...
import { LaporanAssetBendaharaActionDialog } from './laporan-pajak-bendahara-action-dialog'
import { LaporanAssetBendaharaPeriksa } from './laporan-pajak-bendahara-periksa'
import { useRefLaporanAssetBendahara } from './laporan-pajak-bendahara-provider'

export function UsersDialogs() {
  const { open, setOpen, currentRow, setCurrentRow } =
    useRefLaporanAssetBendahara()
  ...
  const handleDelete = async () => {
    ...
    await toast.promise(deletePromise, {
      ...
      success: () => {
        ...
        return `Data "${currentRow.refAssetBendahara?.nm_asset_bendahara}" berhasil dihapus.`
      },
      error: (err) => {
  ...
  const handleDownload = async () => {
    ...
    await toast.promise(
      (async () => {
        ...
        link.setAttribute(
          'download',
          `${currentRow.refAssetBendahara?.nm_asset_bendahara ?? 'laporan'}.pdf`
        )
  ...
  return (
    <>
      <LaporanAssetBendaharaActionDialog
      ...
      {currentRow && (
        <>
          ...
          <ConfirmDialog
            ...
            className='max-w-md'
            title={`Unduh File: ${currentRow.refAssetBendahara?.nm_asset_bendahara}`}
            desc={
              <>
