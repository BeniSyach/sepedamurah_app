...
import { type MasterSkpd, useGetLaporanAssetBendahara } from '@/api'
...
import { LaporanAssetBendaharaProvider } from './components/laporan-dpa-diterima-provider'
import { LaporanAssetBendaharaDiterimaTable } from './components/laporan-dpa-diterima-table'

const route = getRouteApi(
  '/_authenticated/dokumen/laporan-asset-bendahara/laporan-asset-bendahara-diterima'
)

export function LaporanAssetBendaharaDiterima() {
  ...
  const { data, isLoading, isError } = useGetLaporanAssetBendahara({
    ...
    menu:
      userRole === 'Operator SKPKD'
        ? 'operator_laporan_asset_diterima'
        : 'laporan_asset_diterima',
      ...
      <Main>
        ...
        <div className='-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-y-0 lg:space-x-12'>
          ...
          {isLoading ? (
            ...
            <LaporanAssetBendaharaDiterimaTable
              data={data?.data ?? []}
              meta={data?.meta}
              search={search}
              navigate={navigate}
