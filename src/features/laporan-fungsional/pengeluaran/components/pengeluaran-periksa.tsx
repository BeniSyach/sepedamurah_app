...
export function PengeluaranPeriksa({
  open,
  onOpenChange,
  currentRow,
  onAction,
      ...
      <DialogContent className='flex w-full flex-col gap-4 sm:max-w-5xl'>
        <div className='flex gap-4'>
          ...
          <div className='w-1/2 overflow-auto'>
            <DialogHeader>
              <DialogTitle>Preview Laporan Fungsional Pengeluaran</DialogTitle>
              <DialogDescription>
                Melihat detail dan file PDF Laporan Fungsional Pengeluaran.
              </DialogDescription>
            </DialogHeader>
