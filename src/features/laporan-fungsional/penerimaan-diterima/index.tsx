...
import { UsersDialogs } from './components/penerimaan-diterima-dialogs'
import { LaporanFungsionalProvider } from './components/penerimaan-diterima-provider'
...
export function PenerimaanDiterimaLaporanFungsional() {
  ...
  const { data, isLoading, isError } = useGetLaporanFungsional({
    ...
    jenis: 'Penerimaan',
    menu: 'fungsional_penerimaan_diterima',
