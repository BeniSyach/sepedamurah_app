...
import { PenerimaanPeriksa } from '../../penerimaan-diterima/components/penerimaan-diterima-action-dialog'
    ...
    <>
      {currentRow && (
        <>
          ...
          />
          <PenerimaanPeriksa
            key={`fungsional-tolak-periksa-${currentRow.id}`}
            open={open === 'periksa'}
            onOpenChange={() => {
              setOpen('periksa')
              setTimeout(() => {
          ...
          />
          <ConfirmDialog
            key={`fungsional-tolak-lihat-${currentRow.id}`}
            destructive={false}
            open={open === 'lihat'}
            onOpenChange={() => {
              setOpen('lihat')
