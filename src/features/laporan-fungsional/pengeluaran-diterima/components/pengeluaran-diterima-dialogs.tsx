...
import { PengeluaranPeriksa } from './pengeluaran-diterima-action-dialog'
  ...
  return (
    <>
      {currentRow && (
        <>
          <ConfirmDialog
            key={`pengeluaran-diterima-lihat-${currentRow.id}`}
            destructive={false}
            open={open === 'lihat'}
            onOpenChange={() => {
              setOpen('lihat')
          ...
          <ConfirmDialog
            key={`pengeluaran-diterima-download-${currentRow.id}`}
            destructive={false}
            open={open === 'download'}
            onOpenChange={() => {
              setOpen('download')
