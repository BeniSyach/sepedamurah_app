...
export function TerimaFungsionalMultiDialog<TData>({
  ...
  const handleTerima = () => {
    ...
    toast.promise(
      ...
      {
        loading: 'Mengirim data Laporan Fungsioanl Pengeluaran...',
        success: () => {
          table.resetRowSelection()
          return `Berhasil menerima ${selectedRows.length} Laporan Fungsional Pengeluaran.`
        },
        error: (err) => {
    ...
    <ConfirmDialog
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            Apakah Anda yakin Terima Berkas Masuk Fungsional Pengeluaran ini?{' '}
            <br />
