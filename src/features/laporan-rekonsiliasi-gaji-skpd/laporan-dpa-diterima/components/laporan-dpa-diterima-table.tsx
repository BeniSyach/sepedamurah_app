...
import { ReferensiLaporanRekonsiliasiGajiSKPDColumns as columns } from './laporan-dpa-diterima-columns'
...
export function LaporanRekonsiliasiGajiSKPDDiterimaTable({
  data,
  meta,
  search,
  navigate,
