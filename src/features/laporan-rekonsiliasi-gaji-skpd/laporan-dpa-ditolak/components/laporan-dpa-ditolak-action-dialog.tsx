...
type LaporanRekonsiliasiGajiSKPDActionDialogProps = {
...
export function UsersActionDialog({
  ...
  open,
  onOpenChange,
}: LaporanRekonsiliasiGajiSKPDActionDialogProps) {
  ...
  const { data: dataDPA } = useGetRefSp2bToBUD({ page: 1, perPage: 9999 })
    ...
    >
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader className='text-start'>
          ...
          <DialogDescription>
            {isEdit
              ? 'Perbarui data Rekonsiliasi Gaji SKPD.'
              : 'Tambahkan Rekonsiliasi Gaji SKPD baru.'}
          </DialogDescription>
        </DialogHeader>
