import { useDeleteLaporanRekonsiliasiGajiSKPD } from '@/api'
import { toast } from 'sonner'
import { api } from '@/api/common/client'
import { ConfirmDialog } from '@/components/confirm-dialog'
import { LaporanRekonsiliasiGajiSKPDActionDialog } from './laporan-pajak-bendahara-action-dialog'
import { LaporanRekonsiliasiGajiSKPDPeriksa } from './laporan-pajak-bendahara-periksa'
...
export function UsersDialogs() {
  ...
  const { mutateAsync } = useDeleteLaporanRekonsiliasiGajiSKPD()
  ...
  const handleDownload = async () => {
    ...
    await toast.promise(
      (async () => {
        ...
        link.setAttribute(
          'download',
          `${currentRow.RekonsiliasiGajiSKPD?.nm_rekonsiliasi_gaji_skpd ?? 'laporan'}.pdf`
        )
  ...
  return (
    <>
      <LaporanRekonsiliasiGajiSKPDActionDialog
      ...
      {currentRow && (
        <>
          ...
          <LaporanRekonsiliasiGajiSKPDPeriksa
