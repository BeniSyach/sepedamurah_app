...
import { ReferensiLaporanRekonsiliasiGajiSKPDColumns as columns } from './berkas-masuk-dpa-columns'
...
export function BerkasMasukLaporanRekonsiliasiGajiSKPDTable({
  data,
  meta,
  search,
  navigate,
