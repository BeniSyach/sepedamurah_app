...
type RefPermohonanSpdDialogType = 'periksa' | 'edit' | 'lihat' | 'delete'

type RefPermohonanSpdContextType = {
  open: RefPermohonanSpdDialogType | null
  setOpen: (str: RefPermohonanSpdDialogType | null) => void
  currentRow: SpdTerkirim | null
  setCurrentRow: React.Dispatch<React.SetStateAction<SpdTerkirim | null>>
}
...
export function PermohonanSpdProvider({
  ...
  const [currentRow, setCurrentRow] = useState<SpdTerkirim | null>(null)
