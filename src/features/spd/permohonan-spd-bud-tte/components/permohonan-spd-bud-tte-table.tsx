...
import { ReferensiPermohonanSpdColumns as columns } from './permohonan-spd-bud-tte-columns'
...
export function PermohonanSPDBUDTTETable({
  data,
  meta,
  search,
  navigate,
  ...
  return (
    <div className='space-y-4 max-sm:has-[div[role="toolbar"]]:mb-16'>
      <DataTableToolbar
        table={table}
        searchPlaceholder='Cari SPD TTE...'
