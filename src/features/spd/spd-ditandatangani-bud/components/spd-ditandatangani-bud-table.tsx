...
import { ReferensiPermohonanSpdColumns as columns } from './spd-ditandatangani-bud-columns'
...
export function SpdDitandatanganiBUDTable({
  data,
  meta,
  search,
  navigate,
  ...
  return (
    <div className='space-y-4 max-sm:has-[div[role="toolbar"]]:mb-16'>
      <DataTableToolbar
        table={table}
        searchPlaceholder='Cari SPD yg Ditandatangani BUD...'
        searchKey='id_pengirim'
      />
