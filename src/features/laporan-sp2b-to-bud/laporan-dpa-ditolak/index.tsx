...
import { LaporanSp2bToBUDProvider } from './components/laporan-dpa-ditolak-provider'
import { LaporanSp2bToBUDDitolakTable } from './components/laporan-dpa-ditolak-table'

const route = getRouteApi(
  '/_authenticated/dokumen/laporan-sp2b-ke-bud/laporan-sp2b-ke-bud-ditolak'
)

export function LaporanSp2bToBUDDitolak() {
  ...
  const { data, isLoading, isError } = useGetLaporanSp2bToBUD({
    ...
    menu:
      userRole === 'Operator SKPKD'
        ? 'operator_laporan_sp2b_ditolak'
        : 'laporan_sp2b_ditolak',
