...
type LaporanSp2bToBUDActionDialogProps = {
...
export function UsersActionDialog({
  ...
  /* Submit Handler */
  const onSubmit = async (data: LaporanSp2bToBUDForm) => {
        ...
        <DialogHeader className='text-start'>
          <DialogTitle>
            {isEdit
              ...
              : 'Tambah SPB (Surat Pengesahan Belanja)'}
          </DialogTitle>
          <DialogDescription>
            {isEdit
              ? 'Perbarui data SPB (Surat Pengesahan Belanja).'
              : 'Tambahkan SPB (Surat Pengesahan Belanja) baru.'}
          </DialogDescription>
        </DialogHeader>
