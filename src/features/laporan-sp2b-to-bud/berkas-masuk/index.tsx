...
import { LaporanSp2bToBUDProvider } from './components/berkas-masuk-dpa-provider'
import { BerkasMasukLaporanSp2bToBUDTable } from './components/berkas-masuk-dpa-table'

const route = getRouteApi(
  '/_authenticated/dokumen/laporan-sp2b-ke-bud/berkas-masuk'
)

export function BerkasMasukLaporanSp2bToBUD() {
  ...
  const { data, isLoading, isError } = useGetLaporanSp2bToBUD({
    ...
    jenis: 'Penerimaan',
    menu: 'berkas_masuk_laporan_sp2b_ke_bud',
    ...(userRole === 'Bendahara'
      ? {
          user_id: user?.id,
      ...
      <Main>
        ...
        <div className='-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-y-0 lg:space-x-12'>
          ...
          {isLoading ? (
            ...
            <BerkasMasukLaporanSp2bToBUDTable
              data={data?.data ?? []}
              meta={data?.meta}
              search={search}
              navigate={navigate}
