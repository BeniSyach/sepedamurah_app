...
export function TolakFungsionalMultiDialog<TData>({
  ...
  const handleDelete = () => {
    ...
    tolakMulti(formData, {
      onSuccess: () => {
        toast.success(
          `Tolak ${selectedRows.length} Berkas Masuk Laporan Pajak bendahara`
        )
    ...
    toast.loading('Menolak Berkas Laporan Pajak bendahara...')
  }
    ...
    <ConfirmDialog
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            Apakah Anda yakin Menolak Berkas Masuk Laporan Pajak bendahara ini?{' '}
            <br />
          ...
          <Label className='my-4 flex flex-col items-start gap-1.5'>
            <span>
              Ketik Alasan Anda Menolak Berkas Laporan Pajak bendahara untuk
              konfirmasi:
            </span>
            <Input
              value={value}
