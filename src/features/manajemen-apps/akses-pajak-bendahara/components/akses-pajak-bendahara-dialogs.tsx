import { useDeleteAksesPajakBendahara } from '@/api'
import { toast } from 'sonner'
import { ConfirmDialog } from '@/components/confirm-dialog'
import { AksesDPASKPDActionDialog } from './akses-pajak-bendahara-action-dialog'
import { useRefAksesPajakBendaharaGroup } from './akses-pajak-bendahara-provider'

export function UsersDialogs() {
  const { open, setOpen, currentRow, setCurrentRow } =
    useRefAksesPajakBendaharaGroup()

  const { mutateAsync } = useDeleteAksesPajakBendahara()
