...
import { ReferensiUsersRoleColumns as columns } from './user-role-columns'
...
export function UsersRoleTable({
  ...
  const {
    ...
    columnFilters: [{ columnId: 'rule', searchKey: 'rule', type: 'string' }],
  })
  ...
  return (
    <div className='space-y-4 max-sm:has-[div[role="toolbar"]]:mb-16'>
      <DataTableToolbar
        table={table}
        searchPlaceholder='Cari User Rule...'
        searchKey='rule'
      />
