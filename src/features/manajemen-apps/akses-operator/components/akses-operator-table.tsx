...
import { ReferensiAksesOperatorColumns as columns } from './akses-operator-columns'
...
export function AksesOperatorTable({
  data,
  meta,
  search,
  navigate,
  ...
  return (
    <div className='space-y-4 max-sm:has-[div[role="toolbar"]]:mb-16'>
      <DataTableToolbar
        table={table}
        searchPlaceholder='Cari Akses Operator...'
        searchKey='id_operator'
      />
