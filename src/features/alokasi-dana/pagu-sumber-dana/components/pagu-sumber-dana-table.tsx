...
import { ReferensiPaguSumberDanaColumns as columns } from './pagu-sumber-dana-columns'
...
export function PaguSumberDanaTable({
  data,
  meta,
  search,
  navigate,
  ...
  return (
    <div className='space-y-4 max-sm:has-[div[role="toolbar"]]:mb-16'>
      <DataTableToolbar
        table={table}
        searchPlaceholder='Cari Pagu Sumber Dana...'
        searchKey='tgl_rekam'
        filters={[]}
      />
