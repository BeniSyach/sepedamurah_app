...
type RefRealisasiTransferSumberDanaDeleteDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  currentRow: RealisasiTransferSumberDana
}

export function RefRealisasiTransferSumberDanasDeleteDialog({
  open,
  onOpenChange,
  currentRow,
}: RefRealisasiTransferSumberDanaDeleteDialogProps) {
