...
import { useRefLaporanPajakBendahara } from './laporan-dpa-ditolak-provider'
      ...
      {currentRow && (
        <>
          ...
          <ConfirmDialog
            ...
            className='max-w-md'
            title={`Hapus Fungsional Penerimaan Ini: ${currentRow.refPajakBendahara?.nm_pajak_bendahara} ?`}
            desc={
              <>
