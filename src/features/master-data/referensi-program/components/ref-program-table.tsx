...
import { refProgramColummns as columns } from './ref-program-columns'
...
export function RefProgramTable({
  data,
  meta,
  search,
  navigate,
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, _columnId, filterValue) => {
      const nm_program = String(row.getValue('nm_program')).toLowerCase()
      const searchValue = String(filterValue).toLowerCase()

      return nm_program.includes(searchValue)
    },
