...
import { ReferensiCeklisKelengkapanDokumenColumns as columns } from './ref-jenis-spm-columns'
...
export function ReferensiCeklisKelengkapanDokumenTable({
  data,
  meta,
  search,
  navigate,
  ...
  const {
    ...
    columnFilters: [
      { columnId: 'kategori', searchKey: 'kategori', type: 'string' },
  ...
  return (
    <div className='space-y-4 max-sm:has-[div[role="toolbar"]]:mb-16'>
      <DataTableToolbar
        table={table}
        searchPlaceholder='Cari Jenis SPM...'
        searchKey='kategori'
      />
