...
type RefRekeningMultiDeleteDialogProps<TData> = {
  open: boolean
...
export function RefRekeningsMultiDeleteDialog<TData>({
  open,
  onOpenChange,
  table,
}: RefRekeningMultiDeleteDialogProps<TData>) {
    ...
    toast.promise(sleep(2000), {
      ...
      success: () => {
        ...
        return `Telah Dihapus ${selectedRows.length} ${
          selectedRows.length > 1 ? 'Referensi Rekenings' : 'Referensi Rekening'
        }`
      },
      error: 'Error',
    })
