...
const formSchema = z.object({
  ...
  nm_sp2b_ke_bud: z.string().min(1, 'Nama DPA Harus Ada.'),
})
type DPAForm = z.infer<typeof formSchema>

type DPAActionDialogProps = {
  currentRow?: RefSp2dbToBUD
  open: boolean
...
export function DPAsActionDialog({
  ...
  // ✅ Hook React Query
  const { mutateAsync: post } = usePostRefSp2bToBUD()
  const { mutateAsync: put } = usePutRefSp2bToBUD()
