...
export function PenerbitanLPJUPNihil() {
  ...
  const params = {
    ...
    menu:
      userRole === 'Operator SKPKD'
        ? 'permohonan_lpj_up_nihil_operator'
        : 'permohonan_lpj_up_nihil',
          ...
          <div className='mb-2 flex flex-wrap items-center justify-between space-y-2'>
            <div>
              <h2 className='text-2xl font-bold tracking-tight'>
                Permohonan Penerbitan LPJ UPNIHIL
              </h2>
              <p className='text-muted-foreground'>
                Data Ini adalah Permohonan Penerbitan LPJ UPNIHIL
              </p>
            </div>
