...
const route = getRouteApi('/_authenticated/dokumen/lpj-up-nihil/diterima')

// Hitung awal & akhir bulan sekarang
const defaultFrom = startOfMonth(new Date())
const defaultTo = endOfMonth(new Date())

export function PermohonanDiterimaLPJUPNihil() {
  ...
  const params = {
    ...
    menu:
      userRole === 'Operator SKPKD'
        ? 'permohonan_lpj_up_nihil_terima_operator'
        : userRole === 'Kuasa BUD'
          ? 'lpj_up_nihil_diterima_kuasa_bud'
          : 'lpj_up_nihil_diterima',
    // ...(shouldSendDate && {
          ...
          <div className='mb-2 flex flex-wrap items-center justify-between space-y-2'>
            <div>
              <h2 className='text-2xl font-bold tracking-tight'>
                Permohonan Diterima LPJ UPNIHIL
              </h2>
              <p className='text-muted-foreground'>
                Data Ini adalah Permohonan Diterima LPJ UPNIHIL
              </p>
            </div>
