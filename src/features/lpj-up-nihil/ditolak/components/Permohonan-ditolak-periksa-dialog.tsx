...
import { UrusanSection } from '../../penerbitan-lpj-up-nihil/components/urusan-section'
import { mapRekeningToFormData } from '../../penerbitan-lpj-up-nihil/data/mapRekeningToFormData'
...
// 🎨 COMPONENT
// ============================
export function PermohonanDitolakPeriksaDialog({
  currentRow,
  open,
  onOpenChange,
  onAction,
